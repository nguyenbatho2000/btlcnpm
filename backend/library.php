...
define("SMTP_UNAME", "nhaccuviet4th@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "lamvanthai"); //Password for SMTP authentication
